    ...
    <div className="flex flex-col h-auto lg:h-[calc(100vh-128px)] overflow-hidden bg-surface-container-low/30 rounded-3xl">
      <div className="py-6 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div>
          ...
          <h1 className="text-2xl md:text-3xl font-black text-primary-container tracking-tight">Nhân sự</h1>
        </div>
        <div className="flex gap-2 w-full sm:w-auto overflow-x-auto pb-1 sm:pb-0">
          ...
          <button className="flex-1 sm:flex-none justify-center bg-surface-container-highest text-on-surface flex items-center gap-2 px-4 py-2 rounded-md font-bold text-xs transition-all active:scale-95 whitespace-nowrap">
            <Download className="w-4 h-4" /> Xuất Excel
          </button>
          <button 
            onClick={startAdding}
            className="flex-1 sm:flex-none justify-center bg-gradient-to-br from-primary to-primary-container text-white flex items-center gap-2 px-6 py-2 rounded-md font-bold text-xs transition-all active:scale-95 shadow-md whitespace-nowrap"
          >
      ...
      <div className="flex-1 flex flex-col lg:flex-row pb-6 gap-6 overflow-hidden">
                    ...
                    <tr 
                      ...
                      onClick={() => {
                        ...
                        if (window.innerWidth < 1024) {
                          document.getElementById('staff-detail')?.scrollIntoView({ behavior: 'smooth' });
                        }
                      }}
                      className={cn(
        ...
        <div id="staff-detail" className="flex-1 flex flex-col bg-surface-container-lowest rounded-xl shadow-lg border border-primary-container/5 overflow-hidden">
